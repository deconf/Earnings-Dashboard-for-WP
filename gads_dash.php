 ...
 * Plugin URI: https://deconf.com/earnings-dashboard-google-adsense-wordpress/
 * Description: Earnings Dashboard will display Google Adsense earnings and statistics into Admin Dashboard.
 * Author: Alin Marcu
 * Version: 2.3
 * Author URI: https://deconf.com
 * Text Domain: google-adsense-dashboard-for-wp
 */
...
function gads_dash_admin_enqueue_styles( $hook ) {
	$valid_hooks = array( 'settings_page_Earnings_Dashboard' );
...
function gads_dash_settings_link( $links ) {
	$settings_link = '<a href="options-general.php?page=Earnings_Dashboard">' . __( "Settings", 'google-adsense-dashboard-for-wp' ) . '</a>';
...
function gads_dash_content() {
	...
	$optParams = array( 'metric' => array( $query_adsense ), 'dimension' => 'DATE', 'sort' => 'DATE', 'useTimezoneReporting' => get_option( 'gads_dash_timezone' ) );
	try {
	...
	$optParams = array( 'metric' => array( 'EARNINGS', 'COST_PER_CLICK', 'CLICKS', 'PAGE_VIEWS', 'PAGE_VIEWS_CTR', 'PAGE_VIEWS_RPM' ), 'dimension' => 'YEAR', 'useTimezoneReporting' => get_option( 'gads_dash_timezone' ) );
	...
	$optParams = array( 'metric' => array( 'EARNINGS', 'COST_PER_CLICK', 'CLICKS', 'PAGE_VIEWS', 'PAGE_VIEWS_CTR', 'PAGE_VIEWS_RPM' ), 'dimension' => 'CUSTOM_CHANNEL_NAME', 'sort' => '-EARNINGS', 'useTimezoneReporting' => get_option( 'gads_dash_timezone' ) );
	try {
	...
	$optParams = array( 'metric' => array( 'EARNINGS', 'COST_PER_CLICK', 'CLICKS', 'AD_REQUESTS', 'AD_REQUESTS_CTR', 'AD_REQUESTS_RPM' ), 'dimension' => 'AD_UNIT_NAME', 'sort' => '-EARNINGS', 'useTimezoneReporting' => get_option( 'gads_dash_timezone' ) );
	try {
	...
	if ( get_option( 'gads_dash_channels' ) ) {
		...
		if ( $gads_ch_data ) {
			...
			var data = google.visualization.arrayToDataTable([' . "
			  ['" . __( "Channel", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "Earnings", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "CPC", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "Clicks", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "Views", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "CTR", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "RPM", 'google-adsense-dashboard-for-wp' ) . "']," . $gads_ch_data . "
			]);
	...
	if ( get_option( 'gads_dash_ads' ) ) {
		...
		if ( $gads_ads_data ) {
			...
			var data = google.visualization.arrayToDataTable([' . "
			  ['" . __( "Ad Slot", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "Earnings", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "CPC", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "Clicks", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "Requests", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "CTR", 'google-adsense-dashboard-for-wp' ) . "', '" . __( "RPM", 'google-adsense-dashboard-for-wp' ) . "']," . $gads_ads_data . "
			]);
	...
	<center>
		...
		<center>
			<input class="' . $btn_class . '" type="button" value="' . __( "Today", 'google-adsense-dashboard-for-wp' ) . '" onClick="window.location=\'?period_adsense=today&query_adsense=' . $query_adsense . '\'" />
			<input class="' . $btn_class . '" type="button" value="' . __( "Yesterday", 'google-adsense-dashboard-for-wp' ) . '" onClick="window.location=\'?period_adsense=yesterday&query_adsense=' . $query_adsense . '\'" />
			<input class="' . $btn_class . '" type="button" value="' . __( "7 Days", 'google-adsense-dashboard-for-wp' ) . '" onClick="window.location=\'?period_adsense=last7days&query_adsense=' . $query_adsense . '\'" />
			<input class="' . $btn_class . '" type="button" value="' . __( "14 Days", 'google-adsense-dashboard-for-wp' ) . '" onClick="window.location=\'?period_adsense=last14days&query_adsense=' . $query_adsense . '\'" />
			<input class="' . $btn_class . '" type="button" value="' . __( "30 Days", 'google-adsense-dashboard-for-wp' ) . '" onClick="window.location=\'?period_adsense=last30days&query_adsense=' . $query_adsense . '\'" />
		</center>
		</div>
		...
		<div id="adsense_details_div">
			...
			<tr>
			<td width=="24%">' . __( "Earnings:", 'google-adsense-dashboard-for-wp' ) . '</td>
			...
			<td width="30%">' . __( "Views:", 'google-adsense-dashboard-for-wp' ) . '</td>
			...
			<td width="24%">' . __( "Clicks:", 'google-adsense-dashboard-for-wp' ) . '</td>
			...
			<tr>
			<td>' . __( "CPC:", 'google-adsense-dashboard-for-wp' ) . '</td>
			...
			<td>' . __( "CTR:", 'google-adsense-dashboard-for-wp' ) . '</td>
			...
			<td>' . __( "RPM:", 'google-adsense-dashboard-for-wp' ) . '</td>
