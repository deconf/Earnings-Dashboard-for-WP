...
class Google_Config {
	...
	public function __construct( $ini_file_location = null ) {
		$this->configuration = array( 
			...
			'auth_class' => 'Google_Auth_OAuth2', 'io_class' => self::USE_AUTO_IO_SELECTION, 'cache_class' => 'Google_Cache_File', 'logger_class' => 'Google_Logger_Null', 
			...
			'classes' => array( 'Google_IO_Abstract' => array( 'request_timeout_seconds' => 100 ), 'Google_Logger_Abstract' => array( 'level' => 'debug', 'log_format' => "[%datetime%] %level%: %message% %context%\n", 'date_format' => 'd/M/Y:H:i:s O', 'allow_newlines' => true ), 'Google_Logger_File' => array( 'file' => 'php://stdout', 'mode' => 0640, 'lock' => false ), 'Google_Http_Request' => array( 
				...
				'Google_Auth_OAuth2' => array( 
					...
					// Other parameters.
					'hd' => '', 'prompt' => '', 'openid.realm' => '', 'include_granted_scopes' => '', 'login_hint' => '', 'request_visible_actions' => '', 'access_type' => 'online', 'approval_prompt' => 'auto', 'federated_signon_certs_url' => 'https://www.googleapis.com/oauth2/v1/certs' ), 
