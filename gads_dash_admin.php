...
<div id="poststuff">
    <div id="post-body" class="metabox-holder columns-2">
		...
		<h2><?php _e( 'Google Adsense API', 'gads-dash' ); ?></h2>
                        ...
                        <p>
                            <input name="gads_dash_userapi" type="checkbox" id="gads_dash_userapi" onchange="this.form.submit()" value="1" <?php checked(get_option('gads_dash_userapi'),1); ?> /><strong><?php _e(" use your own API Project credentials", 'gads-dash' )?></strong>
                        </p>
		<?php
		...
		if ( get_option( 'gads_dash_token' ) ) {
			?>
			<input type="submit" name="Reset" class="button button-secondary" value="<?php _e( "Clear Authorization", 'gads-dash' );?>" /> <input type="submit" name="Clear" class="button button-secondary" value="<?php _e('Clear Cache', 'gads-dash' ) ?>" /> <input type="hidden" name="gads_dash_hidden" value="Y">
		<?php
		} else {
			?>
			<input type="submit" name="Authorize" class="button button-secondary" value="<?php _e( "Authorize Application", 'gads-dash' );?>" /> <input type="submit" name="Clear" class="button button-secondary" value="<?php _e('Clear Cache', 'gads-dash' ) ?>" /> <input type="hidden" name="gads_dash_hidden" value="A">
                        </p>
                    </form>
...
<?php
		...
		<select id="gads_dash_access" name="gads_dash_access">
                ...
                <p>
                    <input name="gads_dash_channels" type="checkbox" id="gads_dash_channels" value="1" <?php checked(get_option('gads_dash_channels'),1); ?> /><?php _e(" show Custom Channels performance report", 'gads-dash' ); ?></p>
                <p>
                    <input name="gads_dash_ads" type="checkbox" id="gads_dash_ads" value="1" <?php checked(get_option('gads_dash_ads'),1);?> /><?php _e(" show Ad Units performance report", 'gads-dash' ); ?></p>
    ...
    <div id="postbox-container-1" class="postbox-container">
        <div class="meta-box-sortables">
            <div class="postbox">
                ...
                <div class="inside">
                    <a href="https://deconf.com/earnings-dashboard-google-adsense-wordpress/?utm_source=gadswp_config&utm_medium=link&utm_content=video&utm_campaign=gadswp" target="_blank"><img src="<?php echo plugins_url( 'images/earnings-dashboard.png' , __FILE__ );?>" width="100%" alt="" /></a>
                </div>
            </div>
            <div class="postbox">
                <h3>
                ...
                <div class="inside">
                    <div class="deconf-title">
                        <a href="https://deconf.com/earnings-dashboard-google-adsense-wordpress/?utm_source=gadswp_config&utm_medium=link&utm_content=support&utm_campaign=gadswp"><img src="<?php echo plugins_url( 'images/help.png' , __FILE__ ); ?>" /></a>
                    </div>
                    ...
                    <br />
                    <div class="deconf-title">
                        <a href="https://wordpress.org/support/view/plugin-reviews/google-adsense-dashboard-for-wp#plugin-info"><img src="<?php echo plugins_url( 'images/star.png' , __FILE__ ); ?>" /></a>
                    </div>
            ...
            <div class="postbox">
                ...
                <div class="inside">
                    <div class="deconf-title">
                        <a href="https://deconf.com/move-website-https-ssl/?utm_source=gadswp_config&utm_medium=link&utm_content=ssl&utm_campaign=gadswp"><img src="<?php echo plugins_url( 'images/ssl.png' , __FILE__ ); ?>" /></a>
                    </div>
                    ...
                    <br />
                    <div class="deconf-title">
                        <a href="https://deconf.com/wordpress/?utm_source=gadswp_config&utm_medium=link&utm_content=plugins&utm_campaign=gadswp"><img src="<?php echo plugins_url( 'images/wp.png' , __FILE__ ); ?>" /></a>
                    </div>
            ...
            <div class="postbox">
                ...
                <div class="inside">
                    ...
                    <div class="deconf-desc"><?php echo  __('Speed up your website and plug into a whole', 'gads-dash').' <a href="https://deconf.com/wordpress-cdn-speeds-up-your-site/">'.__('new level of site speed', 'gads-dash').'</a>.'; ?></div>
                    <br />
                    <div class="deconf-title">
                        <a href="https://deconf.com/clicky-web-analytics-review/?utm_source=gadswp_config&utm_medium=link&utm_content=clicky&utm_campaign=gadswp"><img src="<?php echo plugins_url( 'images/clicky.png' , __FILE__ ); ?>" /></a>
                    </div>
